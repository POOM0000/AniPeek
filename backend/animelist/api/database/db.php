...
$dbname = 'animelist';  // ชื่อฐานข้อมูล
$username = 'root';  // ชื่อผู้ใช้ฐานข้อมูล (คงเดิมหรือเปลี่ยนตามความเหมาะสม)
$password = '';  // รหัสผ่านฐานข้อมูล (คงเดิมหรือเปลี่ยนตามความเหมาะสม)
